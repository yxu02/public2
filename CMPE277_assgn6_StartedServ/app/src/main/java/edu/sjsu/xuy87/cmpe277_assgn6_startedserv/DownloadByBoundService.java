...
public class DownloadByBoundService extends Service {

    private MyLocalBinder myLocalBinder = new MyLocalBinder();

    public class MyLocalBinder extends Binder {

        DownloadByBoundService getService() {
            return DownloadByBoundService.this;
        }
    }
    ...
    private void downloadHelper(String url, String destFile) {
